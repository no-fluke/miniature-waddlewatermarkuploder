    ...
    for user_id in list(set(TOTAL_USERS)):
        try:
            if message.reply_to_message.text:
                ...
                await client.send_photo(user_id, photo=message.reply_to_message.photo.file_id, caption=message.reply_to_message.caption or "")
            elif message.reply_to_message.video:
                await client.send_video(user_id, video=message.reply_to_message.video.file_id, caption=message.reply_to_message.caption or "")
            elif message.reply_to_message.document:
                await client.send_document(user_id, document=message.reply_to_message.document.file_id, caption=message.reply_to_message.caption or "")
            else:
...
async def cookies_handler(client: Client, m: Message):
    editable = await m.reply_text("**Please upload the YouTube Cookies file (.txt format).**", quote=True)
    try:
...
async def start(bot, m: Message):
    ...
    await start_message.edit_text(f"🌟 Welcome {m.from_user.first_name}! 🌟\n\nInitializing Uploader bot... 🤖\n\nProgress: [⬜️⬜️⬜️⬜️⬜️⬜️⬜️⬜️⬜️⬜️] 0%\n\n")
    await asyncio.sleep(1)
...
async def back_to_main_menu(client, callback_query):
    ...
    await callback_query.message.edit_media(InputMediaPhoto(media="https://envs.sh/GVI.jpg", caption=caption), reply_markup=keyboard)
...
async def cmd(client, callback_query):
    ...
    await callback_query.message.edit_media(InputMediaPhoto(media="https://tinypic.host/images/2025/07/14/file_00000000fc2461fbbdd6bc500cecbff8_conversation_id6874702c-9760-800e-b0bf-8e0bcf8a3833message_id964012ce-7ef5-4ad4-88e0-1c41ed240c03-1-1.jpg", caption=caption), reply_markup=keyboard)
...
async def feature_button(client, callback_query):
    ...
    await callback_query.message.edit_media(InputMediaPhoto(media="https://tinypic.host/images/2025/07/14/file_000000002d44622f856a002a219cf27aconversation_id68747543-56d8-800e-ae47-bb6438a09851message_id8e8cbfb5-ea6c-4f59-974a-43bdf87130c0.png", caption=caption), reply_markup=keyboard)
...
async def txt_handler(bot: Client, m: Message):
    ...
    if raw_text4 == '/d':
        cwtoken = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..snDdd-PbaoC42OUhn5SJaEGxq0VzfdzO49WTmYgTx8ra_Lz66GySZykpd2SxIZCnrKR6-R10F5sUSrKATv1CDk9ruj_ltCjEkcRq8mAqAytDcEBp72-W0Z7DtGi8LdnY7Vd9Kpaf499P-y3-godolS_7ixClcYOnWxe2nSVD5C9c5HkyisrHTvf6NFAuQC_FD3TzByldbPVKK0ag1UnHRavX8MtttjshnRhv5gJs5DQWj4Ir_dkMcJ4JaVZO3z8j0OxVLjnmuaRBujT-1pavsr1CCzjTbAcBvdjUfvzEhObWfA1-Vl5Y4bUgRHhl1U-0hne4-5fF0aouyu71Y6W0eg'
        cptoken = "cptoken"
        pwtoken = "pwtoken"
    else:
        cwtoken = raw_text4
    ...
    await editable.edit(
        ...
        f"<blockquote>Send your watermark text (e.g. `@YourChannel`)\n"
        f"or send /d to skip</blockquote>"
    )
    try:
        input_wm: Message = await bot.listen(editable.chat.id, timeout=20)
            ...
            try:
                ...
                if raw_text5.lower() == "yes":
                    ...
                    if t_name in topic_cache:
                        ...
                        try:
                            api_resp = requests.post(f"https://api.telegram.org/bot{BOT_TOKEN}/createForumTopic", json={"chat_id": channel_id, "name": t_name}).json()
                ...
                if "drive" in url:
                    ...
                    Show1 = f"<blockquote>🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%</blockquote>\n┃\n┣🔗𝐈𝐧𝐝𝐞𝐱 » {count}/{len(links)}\n┃\n╰━🖇️𝐑𝐞𝐦𝐚𝐢𝐧 » {remaining_links}\n━━━━━━━━━━━━━━━━━━━━━━━━\n<blockquote><b>⚡Dᴏᴡɴʟᴏᴀᴅɪɴɢ Eɴᴄʀʏᴘᴛᴇᴅ Sᴛᴀʀᴛᴇᴅ...⏳</b></blockquote>\n┃\n┣💃𝐂𝐫𝐞𝐝𝐢𝐭 » {CR}\n┃\n╰━📚𝐁𝐚𝐭𝐜𝐡 » {b_name}\n━━━━━━━━━━━━━━━━━━━━━━━━━\n<blockquote>📚𝐓𝐢𝐭𝐥𝐞 » {name}</blockquote>\n┃\n┣🍁𝐐𝐮𝐚𝐥𝐢𝐭𝐲 » {quality}\n┃\n┣━🔗𝐋𝐢𝐧𝐤 » <a href=\"{link0}\">**Original Link**</a>\n┃\n╰━━🖇️𝐔𝐫𝐥 » <a href=\"{url}\">**Api Link**</a>\n━━━━━━━━━━━━━━━━━━━━━━━━━\n🛑**Send** /stop **to stop process**\n┃\n╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ {CREDIT}"
                    Show = f"<i><b>Video Downloading</b></i>\n<blockquote><b>{str(count).zfill(3)}) {name1}</b></blockquote>"
                    prog = await bot.send_message(channel_id, Show, disable_web_page_preview=True, **({'message_thread_id': current_topic_id} if current_topic_id else {}))
                    ...
                    remaining_links = len(links) - count
                    progress = (count / len(links)) * 100
                    Show1 = f"<blockquote>🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%</blockquote>\n┃\n┣🔗𝐈𝐧𝐝𝐞𝐱 » {count}/{len(links)}\n┃\n╰━🖇️𝐑𝐞𝐦𝐚𝐢𝐧 » {remaining_links}\n━━━━━━━━━━━━━━━━━━━━━━━━\n<blockquote><b>⚡Dᴏᴡɴʟᴏᴀᴅɪɴɢ Sᴛᴀʀᴛᴇᴅ...⏳</b></blockquote>\n┃\n┣💃𝐂𝐫𝐞𝐝𝐢𝐭 » {CR}\n┃\n╰━📚𝐁𝐚𝐭𝐜𝐡 » {b_name}\n━━━━━━━━━━━━━━━━━━━━━━━━━\n<blockquote>📚𝐓𝐢𝐭𝐥𝐞 » {name}</blockquote>\n┃\n┣🍁𝐐𝐮𝐚𝐥𝐢𝐭𝐲 » {quality}\n┃\n┣━🔗𝐋𝐢𝐧𝐤 » <a href=\"{link0}\">**Original Link**</a>\n┃\n╰━━🖇️𝐔𝐫𝐥 » <a href=\"{url}\">**Api Link**</a>\n━━━━━━━━━━━━━━━━━━━━━━━━━\n🛑**Send** /stop **to stop process**\n┃\n╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ {CREDIT}"
                    Show = f"<i><b>Video Downloading</b></i>\n<blockquote><b>{str(count).zfill(3)}) {name1}</b></blockquote>"
                    prog = await bot.send_message(channel_id, Show, disable_web_page_preview=True, **({'message_thread_id': current_topic_id} if current_topic_id else {}))
                    prog1 = await m.reply_text(Show1, disable_web_page_preview=True)
...
async def text_handler(bot: Client, m: Message):
    ...
    if ".pdf" in link or ".jpeg" in link or ".jpg" in link or ".png" in link:
        ...
        quality = "360p"
        res = "640x360"
        single_watermark = None   # no watermark prompt for non-video files
    else:
    ...
    try:
        ...
        try:
            ...
            if "drive" in url:
                ...
                Show = f"**⚡Dᴏᴡɴʟᴏᴀᴅɪɴɢ Sᴛᴀʀᴛᴇᴅ...⏳**\n<blockquote expandable>🔗𝐋𝐢𝐧𝐤 » {url}</blockquote>\n✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ {CREDIT}"
